...
def main():
    ...
    while(menu!="q"):
        ...
        x = input("Choose x exponente value: ")
        n = input("Choose n approximation terms number: ")
        print("The exponential approximation of e^" + x +" with n="+ n +" terms is:")
        print(e_func(x,n))
